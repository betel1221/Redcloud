...
const initialMessages: Message[] = [
  {
    id: 1,
    sender: 'ai',
    text: 'Hello, Administrator. I am your ERAOP Infrastructure Assistant. I have access to real-time monitoring data, logs, and the company knowledge base. How can I help you today?',
    timestamp: '10:00 AM'
  },
  {
    id: 2,
    ...
    <div className="h-full flex flex-col glass-panel animate-fade-in">
      <div className="p-4 border-b border-border flex items-center justify-between bg-surface/50 rounded-t-2xl">
        <div className="flex items-center">
          ...
          <div>
            <h2 className="text-lg font-bold text-textPrimary">ERAOP Assistant</h2>
